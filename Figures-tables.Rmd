...
# Packages
PKG <- c("multcomp","multcompView","tidyverse","scales","gridExtra","ggthemes","viridis","knitr","sf","exactextractr","raster","data.table","sf", "RColorBrewer","tmap", "ggpubr") # https://rud.is/b/2016/02/14/making-faceted-heatmaps-with-ggplot2/
...
yrange <- bbox_new$ymax - bbox_new$ymin
  ...
  bbox_new[3] <- bbox_new[3] - (0.35 * xrange) # xmax - right -.35
...
d_i<-ggplot(stst[stst$Type=="internal",], aes(x=Geomorphic,y=Damage,fill=Geomorphic)) +
  ...
  #labs(y = "Damage", x = "Geomorphic Type", fill = "OLU Geomorphic Type")
...
v_i<-ggplot(stst[stst$Type=="internal",], aes(x=Geomorphic,y=Volume,fill=Geomorphic)) +
  ...
  theme(axis.text.x=element_blank(), axis.title.x = element_blank(), axis.title.y = element_blank(), legend.title = element_blank(), legend.box = "horizontal")
  #labs(y = "Volume", x = "Geomorphic Type", fill = "OLU Geomorphic Type")
