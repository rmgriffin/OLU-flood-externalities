...
rm(PKG,p)
# Load data
tresult<-read.csv("C:/Users/XPSXIII/Documents/Stanford/California/Stormwater/OLUs/Floodmaps_v2/tresult_v2.csv")
...
## Protecting San Mateo OLU (OLU 26) leads to very large external benefits for Belmont-Redwood OLU (OLU 25) under 50cm SLR

```{r, echo=FALSE, fig.cap="Same scale all panels", out.width = '100%', fig.align="center"}
knitr::include_graphics("C:/Users/XPSXIII/Documents/Stanford/California/Stormwater/OLUs/Floodmaps_v2/Figs/Flood progression and OLU7/V2/Presentation1.png")
```
...
df<-df %>%
  ...
  summarize_at(vars(net.damage),sum)
# NLCD 2016 raster
NLCD<-raster("C:/Users/XPSXIII/Documents/Stanford/California/Stormwater/OLUs/Floodmaps_v2/NLCD_2016_Land_Cover_L48_20190424/NLCD_2016_Land_Cover_L48_20190424.tif")
# OLU shapefile
OLU<-st_read("C:/Users/XPSXIII/Documents/Stanford/California/Stormwater/OLUs/Floodmaps_v2/olu_NAD83_10N.gpkg")
...
# Elevation
Ele<-raster("C:/Users/XPSXIII/Documents/Stanford/California/Stormwater/OLUs/Floodmaps_v2/dem90m/olu_dem90m.tif")
...
knitr::include_graphics("C:/Users/XPSXIII/Documents/Stanford/California/Stormwater/OLUs/Floodmaps_v2/NLCD_Colour_Classification_Update.jpg")
```

**Landcover within geomorphic types**
...
ggplot(lc, aes(y=landcover,x=area,fill=Geomorphic))+
  geom_boxplot() +
  theme_minimal() +
  labs(y = "NLCD Land Cover Class", x = "Area (km2)", fill = "OLU Geomorphic Type") +
  scale_y_discrete(labels=c("X11" = "Open Water", 
                              "X2" = "Development",
                              "X31" = "Barren",
                              "X4" = "Forest",
                              "X52" = "Shrub",
...
# # Boxplot by percent area
# ggplot(lc, aes(x=landcover,y=Ptg,fill=Geomorphic))+
#   geom_boxplot() +
#   theme_minimal()

# Tukey test for wetlands (area)
amod<-aov(area~Geomorphic,data=lc,subset=landcover=="X9") # change this for relevant comparison
#plot(amod) 
TukeyHSD(amod)

# Tukey test for grasslands (area)
amod<-aov(area~Geomorphic,data=lc,subset=landcover=="X71") # change this for relevant comparison
#plot(amod)
TukeyHSD(amod)

# Tukey test for agricultural (area)
amod<-aov(area~Geomorphic,data=lc,subset=landcover=="X8") # change this for relevant comparison
#plot(amod) 
TukeyHSD(amod)
```
...
```{r, include = FALSE}
setwd("C:/Users/XPSXIII/Documents/Stanford/California/Stormwater/OLUs/Floodmaps_v2/")
Exposure<-st_read("Exposure4OLU3.gpkg")
...
```{r, echo = FALSE, fig.align="center"}
kable(cf2, caption = "Overall net benefit and net impacted census blocks from protection, across SLR scenarios. Net = internal + external", digits = 1, format.args = list(big.mark = ","))
```
...
fresult<-read.csv("C:/Users/XPSXIII/Documents/Stanford/California/Stormwater/OLUs/Floodmaps_v2/fresult_v2.csv")
...
```{r, include=FALSE}
Pop<-raster("C:/Users/XPSXIII/Documents/Github/CA-recreation-coastal-hazards/Data/dasymetric_us_20160208.tif")
...
```{r, include=FALSE}
H37<-st_read("C:/Users/XPSXIII/Documents/Github/CA-recreation-coastal-hazards/Data/Roads_2015.gpkg")
...
SLR100<-raster("C:/Users/XPSXIII/Documents/Stanford/California/Stormwater/OLUs/Floodmaps_v2/Figs/Flood progression and OLU7/base_SLR100_olu_00000-0-0-000-000000-00000-00-00000-00_depth.tif")
...
#tmap_save(OLU7f,"C:/Users/XPSXIII/Documents/Stanford/California/Stormwater/OLUs/Floodmaps_v2/Figs/Flood progression and OLU7/OLU7f.eps") # https://rdrr.io/cran/tmap/man/tmap_save.html
```
...
```{r, echo=FALSE, fig.align="center"}
# Flood maps are in meters
SLR50<-raster("C:/Users/XPSXIII/Documents/Stanford/California/Stormwater/OLUs/Floodmaps_v2/Figs/Flood progression and OLU7/base_SLR50_olu_00000-0-0-000-000000-00000-00-00000-00_depth.tif")
SLR50.26<-raster("C:/Users/XPSXIII/Documents/Stanford/California/Stormwater/OLUs/Floodmaps_v2/Figs/Flood progression and OLU7/v2_OLU26_SLR50_olu_00000-0-0-000-000000-00000-00-00100-00_depth.tif")
SLR100.26<-raster("C:/Users/XPSXIII/Documents/Stanford/California/Stormwater/OLUs/Floodmaps_v2/Figs/Flood progression and OLU7/v2_OLU26_SLR100_olu_00000-0-0-000-000000-00000-00-00100-00_depth.tif")
...
#tmap_save(OLU2526f,"C:/Users/XPSXIII/Documents/Stanford/California/Stormwater/OLUs/Floodmaps_v2/Figs/Flood progression and OLU7/OLU2526f.eps") # https://rdrr.io/cran/tmap/man/tmap_save.html
```
